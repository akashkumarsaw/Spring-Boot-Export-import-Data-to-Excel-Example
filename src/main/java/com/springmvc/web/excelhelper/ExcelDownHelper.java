package com.springmvc.web.excelhelper;
...
public class ExcelDownHelper {
    ...
    public ExcelDownHelper(List<Student> studentsList) {
    ...
    private void writeDataLines() {
        ...
        for (Student student : studentsList) {
            ...
            createCell(row, columnCount++, student.getName().toString(), style);
            
            createCell(row, columnCount++, student.getEmail().toString(), style);
            
            createCell(row, columnCount++, student.getPhone().toString(), style);
